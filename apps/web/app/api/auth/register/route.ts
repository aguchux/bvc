...
import { getMoodleClient, getMoodleLoginClient } from "../../../../lib/moodle";
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const moodleUser = await client.createUser({
            username,
            password,
            firstname,
            lastname,
        ...
        const clientLogin = getMoodleLoginClient();
        const tokenPayload = await clientLogin.login(username, password);
