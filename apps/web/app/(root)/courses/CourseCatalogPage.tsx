...
const stripDefaultCoursePayload = (
  data: any[] | undefined,
): MoodleCourseType[] => {
      ...
      <section className="grid gap-6 rounded-3xl border border-[var(--border)] bg-white p-6 shadow-sm md:grid-cols-2 md:items-end">
        <div className="space-y-4">
          ...
          <p className="text-slate-600">
            Explore industry-aligned training delivered through our Moodle
            learning management system. Browse the catalogue, view course
            details, and join the classes that move your skills forward.
          </p>
