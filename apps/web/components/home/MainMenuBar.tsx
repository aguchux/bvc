        ...
        <header className="relative z-40 backdrop-blur" id="main-menu-bar">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
                <nav
                    ...
                    className="hidden items-center gap-4 lg:flex z-10"
                    aria-label="Primary"
                >
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        className={`absolute left-1/2 top-full z-20 mt-3 w-screen max-w-lg -translate-x-1/2 rounded-xl bg-white p-6 shadow-lg transition-opacity duration-200 ${megaOpen ? "opacity-100" : "opacity-0 pointer-events-none"
                                            }`}
                                        onMouseEnter={() => {
                                            if (closeTimer.current)
                                                window.clearTimeout(closeTimer.current);
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        className={`absolute left-1/2 top-full z-20 mt-3 w-screen max-w-5xl -translate-x-1/2 rounded-2xl bg-white p-6 shadow-lg transition-all duration-200 ${isDropdownOpen
                                            ? "opacity-100"
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        aria-label={`${l.label} menu`}
                                        aria-hidden={!isDropdownOpen}
                                        className={`absolute left-0 top-full z-20 mt-2 min-w-[220px] rounded-xl bg-white p-3 shadow-lg transition-all duration-200 ${isDropdownOpen
                                            ? "opacity-100"
                                            : "opacity-0 pointer-events-none scale-95"
                                            }`}
                                    >
                            ...
                            return (
                                <div key={l.label ?? idx} className="relative">
                                    <Link
                                        key={l.label ?? idx}
                                        href={l.href ?? "#"}
                                        className={`inline-flex h-full ${l.spotlight ? "border border-[#0f5e78] text-white px-3 py-1 rounded-full" : "text-slate-700"} cursor-pointer items-center gap-2 text-[15px] font-medium ${isActiveGroup ? "text-[#0f5e78]" : "text-slate-700"} hover:text-slate-900`}
                                    >
                                        {l.label}
                                    </Link>
                                    {isActiveGroup && (
